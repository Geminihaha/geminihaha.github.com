...
var require_bytebuffer = __commonJS({
  "node_modules/bytebuffer/dist/bytebuffer.js"(exports, module) {
    (function(global, factory) {
      ...
      "use strict";
      var ByteBuffer3 = function(capacity, littleEndian, noAssert) {
        if (typeof capacity === "undefined")
          capacity = ByteBuffer3.DEFAULT_CAPACITY;
        if (typeof littleEndian === "undefined")
          littleEndian = ByteBuffer3.DEFAULT_ENDIAN;
        if (typeof noAssert === "undefined")
          noAssert = ByteBuffer3.DEFAULT_NOASSERT;
        if (!noAssert) {
          capacity = capacity | 0;
          if (capacity < 0)
      ...
      ByteBuffer3.VERSION = "5.0.1";
      ByteBuffer3.LITTLE_ENDIAN = true;
      ByteBuffer3.BIG_ENDIAN = false;
      ByteBuffer3.DEFAULT_CAPACITY = 16;
      ByteBuffer3.DEFAULT_ENDIAN = ByteBuffer3.BIG_ENDIAN;
      ByteBuffer3.DEFAULT_NOASSERT = false;
      ByteBuffer3.Long = Long || null;
      var ByteBufferPrototype = ByteBuffer3.prototype;
      ...
      ByteBuffer3.accessor = function() {
        return Uint8Array;
      };
      ByteBuffer3.allocate = function(capacity, littleEndian, noAssert) {
        return new ByteBuffer3(capacity, littleEndian, noAssert);
      };
      ByteBuffer3.concat = function(buffers, encoding, littleEndian, noAssert) {
        ...
        for (var i = 0, k = buffers.length, length; i < k; ++i) {
          if (!ByteBuffer3.isByteBuffer(buffers[i]))
            buffers[i] = ByteBuffer3.wrap(buffers[i], encoding);
          length = buffers[i].limit - buffers[i].offset;
          if (length > 0) capacity += length;
        }
        if (capacity === 0)
          return new ByteBuffer3(0, littleEndian, noAssert);
        var bb = new ByteBuffer3(capacity, littleEndian, noAssert), bi;
        i = 0;
        while (i < k) {
          bi = buffers[i++];
      ...
      ByteBuffer3.isByteBuffer = function(bb) {
        return (bb && bb["__isByteBuffer__"]) === true;
      };
      ByteBuffer3.type = function() {
        return ArrayBuffer;
      };
      ByteBuffer3.wrap = function(buffer, encoding, littleEndian, noAssert) {
        ...
        if (typeof buffer === "string") {
          ...
          switch (encoding) {
            case "base64":
              return ByteBuffer3.fromBase64(buffer, littleEndian);
            case "hex":
              return ByteBuffer3.fromHex(buffer, littleEndian);
            case "binary":
              return ByteBuffer3.fromBinary(buffer, littleEndian);
            case "utf8":
              return ByteBuffer3.fromUTF8(buffer, littleEndian);
            case "debug":
              return ByteBuffer3.fromDebug(buffer, littleEndian);
            default:
        ...
        var bb;
        if (ByteBuffer3.isByteBuffer(buffer)) {
          bb = ByteBufferPrototype.clone.call(buffer);
          bb.markedOffset = -1;
          return bb;
        }
        if (buffer instanceof Uint8Array) {
          bb = new ByteBuffer3(0, littleEndian, noAssert);
          if (buffer.length > 0) {
          ...
          bb = new ByteBuffer3(buffer.length, littleEndian, noAssert);
      ...
      ByteBuffer3.MAX_VARINT32_BYTES = 5;
      ByteBuffer3.calculateVarint32 = function(value) {
        value = value >>> 0;
      ...
      ByteBuffer3.zigZagEncode32 = function(n) {
        return ((n |= 0) << 1 ^ n >> 31) >>> 0;
      };
      ByteBuffer3.zigZagDecode32 = function(n) {
        return n >>> 1 ^ -(n & 1) | 0;
      };
      ByteBufferPrototype.writeVarint32 = function(value, offset) {
        ...
        var size = ByteBuffer3.calculateVarint32(value), b;
        offset += size;
      ...
      ByteBufferPrototype.writeVarint32ZigZag = function(value, offset) {
        return this.writeVarint32(ByteBuffer3.zigZagEncode32(value), offset);
      };
      ...
      ByteBufferPrototype.readVarint32ZigZag = function(offset) {
        ...
        if (typeof val === "object")
          val["value"] = ByteBuffer3.zigZagDecode32(val["value"]);
        else
          val = ByteBuffer3.zigZagDecode32(val);
        return val;
      };
      if (Long) {
        ByteBuffer3.MAX_VARINT64_BYTES = 10;
        ByteBuffer3.calculateVarint64 = function(value) {
          if (typeof value === "number")
            value = Long.fromNumber(value);
          else if (typeof value === "string")
            value = Long.fromString(value);
        ...
        ByteBuffer3.zigZagEncode64 = function(value) {
          if (typeof value === "number")
        ...
        ByteBuffer3.zigZagDecode64 = function(value) {
          if (typeof value === "number")
            value = Long.fromNumber(value, false);
          else if (typeof value === "string")
            value = Long.fromString(value, false);
        ...
        ByteBufferPrototype.writeVarint64 = function(value, offset) {
          ...
          var size = ByteBuffer3.calculateVarint64(value), part0 = value.toInt() >>> 0, part1 = value.shiftRightUnsigned(28).toInt() >>> 0, part2 = value.shiftRightUnsigned(56).toInt() >>> 0;
          offset += size;
        ...
        ByteBufferPrototype.writeVarint64ZigZag = function(value, offset) {
          return this.writeVarint64(ByteBuffer3.zigZagEncode64(value), offset);
        };
        ...
        ByteBufferPrototype.readVarint64ZigZag = function(offset) {
          ...
          if (val && val["value"] instanceof Long)
            val["value"] = ByteBuffer3.zigZagDecode64(val["value"]);
          else
            val = ByteBuffer3.zigZagDecode64(val);
          return val;
        };
      }
      ...
      ByteBufferPrototype.readIString = function(offset) {
        ...
        var str = this.readUTF8String(len, ByteBuffer3.METRICS_BYTES, offset += 4);
        offset += str["length"];
        if (relative) {
          this.offset = offset;
          return str["string"];
      ...
      ByteBuffer3.METRICS_CHARS = "c";
      ByteBuffer3.METRICS_BYTES = "b";
      ...
      ByteBuffer3.calculateUTF8Chars = function(str) {
        return utfx.calculateUTF16asUTF8(stringSource(str))[0];
      };
      ByteBuffer3.calculateUTF8Bytes = function(str) {
        return utfx.calculateUTF16asUTF8(stringSource(str))[1];
      };
      ByteBuffer3.calculateString = ByteBuffer3.calculateUTF8Bytes;
      ByteBufferPrototype.readUTF8String = function(length, metrics, offset) {
        ...
        var relative = typeof offset === "undefined";
        if (relative) offset = this.offset;
        if (typeof metrics === "undefined") metrics = ByteBuffer3.METRICS_CHARS;
        if (!this.noAssert) {
        ...
        if (metrics === ByteBuffer3.METRICS_CHARS) {
        ...
        } else if (metrics === ByteBuffer3.METRICS_BYTES) {
          if (!this.noAssert) {
            if (typeof offset !== "number" || offset % 1 !== 0)
              throw TypeError("Illegal offset: " + offset + " (not an integer)");
            offset >>>= 0;
      ...
      ByteBufferPrototype.writeVString = function(str, offset) {
        ...
        k = utfx.calculateUTF16asUTF8(stringSource(str), this.noAssert)[1];
        l = ByteBuffer3.calculateVarint32(k);
        offset += l + k;
      ...
      ByteBufferPrototype.readVString = function(offset) {
        ...
        var str = this.readUTF8String(len["value"], ByteBuffer3.METRICS_BYTES, offset += len["length"]);
        offset += str["length"];
        if (relative) {
          this.offset = offset;
          return str["string"];
      ...
      ByteBufferPrototype.append = function(source, encoding, offset) {
        ...
        if (!(source instanceof ByteBuffer3))
          source = ByteBuffer3.wrap(source, encoding);
      ...
      ByteBufferPrototype.clone = function(copy) {
        var bb = new ByteBuffer3(0, this.littleEndian, this.noAssert);
        if (copy) {
      ...
      ByteBufferPrototype.copy = function(begin, end) {
        ...
        if (begin === end)
          return new ByteBuffer3(0, this.littleEndian, this.noAssert);
        var capacity = end - begin, bb = new ByteBuffer3(capacity, this.littleEndian, this.noAssert);
        bb.offset = 0;
        bb.limit = capacity;
      ...
      ByteBufferPrototype.copyTo = function(target, targetOffset, sourceOffset, sourceLimit) {
        ...
        if (!this.noAssert) {
          if (!ByteBuffer3.isByteBuffer(target))
      ...
      ByteBuffer3.fromBase64 = function(str, littleEndian) {
        if (typeof str !== "string")
          throw TypeError("str");
        var bb = new ByteBuffer3(str.length / 4 * 3, littleEndian), i = 0;
      ...
      ByteBuffer3.btoa = function(str) {
        return ByteBuffer3.fromBinary(str).toBase64();
      };
      ByteBuffer3.atob = function(b64) {
        return ByteBuffer3.fromBase64(b64).toBinary();
      };
      ...
      ByteBuffer3.fromBinary = function(str, littleEndian) {
        if (typeof str !== "string")
          throw TypeError("str");
        var i = 0, k = str.length, charCode, bb = new ByteBuffer3(k, littleEndian);
        while (i < k) {
      ...
      ByteBuffer3.fromDebug = function(str, littleEndian, noAssert) {
        var k = str.length, bb = new ByteBuffer3((k + 1) / 3 | 0, littleEndian, noAssert);
      ...
      ByteBuffer3.fromHex = function(str, littleEndian, noAssert) {
        if (!noAssert) {
          if (typeof str !== "string")
            throw TypeError("Illegal str: Not a string");
          if (str.length % 2 !== 0)
        ...
        var k = str.length, bb = new ByteBuffer3(k / 2 | 0, littleEndian), b;
      ...
      ByteBuffer3.fromUTF8 = function(str, littleEndian, noAssert) {
        if (!noAssert) {
          if (typeof str !== "string")
            throw TypeError("Illegal str: Not a string");
        }
        var bb = new ByteBuffer3(utfx.calculateUTF16asUTF8(stringSource(str), true)[1], littleEndian, noAssert), i = 0;
        utfx.encodeUTF16toUTF8(stringSource(str), function(b) {
          bb.view[i++] = b;
        });
        bb.limit = i;
...
var eventDispatcher = new import_events.EventEmitter();
function sharedEventDispatcher() {
  return eventDispatcher;
}

// bletrs/lib/pixl.ble.js
var ByteBuffer = __toESM(require_bytebuffer());
